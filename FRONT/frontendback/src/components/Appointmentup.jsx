    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:4000/appoint/doctor/${selectedDoctor._id}`,
                { date, reason },
                {
                    headers: { Authorization: `Bearer ${token}` },
                }
    ...
    return (
        <div style={{ margin: '20px', fontFamily: 'Arial, sans-serif' }}>
            {!selectedDoctor ? (
                ...
                <div>
                    <h2>Update Appointment for {selectedDoctor.name}</h2>
...
const App = () => {
    ...
    // Manual token system
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3M2RhZTg5NTNmZjM5ZmE5ZmFlOTJiNSIsImlhdCI6MTczMjA5NTYyNiwiZXhwIjoxNzQwNzM1NjI2fQ.0IyL-Fq5nfCAuQ3x0IHrDhA0m0ZNYPElKuLM0Z3g01w'; // Place your token here
